...
*/
    ...
    {
        $panjang_kata = strlen($string); // finding string length
        $balik_String = ''; // store the reversed string

        for ($i = $panjang_kata - 1; $i >= 0; $i--) { // iterating to reverse the string
            $balik_String .= $string[$i];
        }
        return $balik_String;
    }
